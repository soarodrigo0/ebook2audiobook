...
def web_interface(args, ctx):
    ...
    with gr.Blocks(theme=theme, title=title, css=header_css, delete_cache=(86400, 86400)) as app:
        ...
        with gr_group_audiobook_list:
            ...
            gr_audiobook_player_playback_time = gr.Textbox(label='', interactive=False, visible=True, elem_id="gr_audiobook_player_playback_time")
                        ...
                        if (typeof(window.load_vtt) !== 'function') {
                            window.load_vtt = (path) => {
                                try {
                                    ...
                                    const gr_audiobook_player_playback_time = gr_root.querySelector("#gr_audiobook_player_playback_time");
